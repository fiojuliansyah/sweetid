    ...
    <div class="content-body">
        <div class="container-fluid">
            ...
            <div class="row">
                                ...
                                <div class="row m-b-30">
                                    <div class="col-md-5 col-xxl-12">
                                        <div class="new-arrival-product mb-4 mb-xxl-4 mb-md-0">
                                            <div class="new-arrivals-img-contnent">
                                                <img class="img-fluid"
                                                    src="{{ Storage::url($room->images->first()->image ?? '') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-7 col-xxl-12">
                                        <div class="new-arrival-content position-relative">
                                            <h4><a href="{{ route('rooms.show', $room->id) }}">{{ $room->title }}</a>
                                            </h4>
                                            <div class="comment-review star-rating">
                                                ...
                                                <br>
                                                <span class="review-text">(34 member) / </span><a class="product-review"
                ...
                <a href="{{ route('discussions.index', ['room' => $room->id]) }}"
                    class="btn btn-primary btn-sm">Discussion</a>
                <a href="{{ route('rooms.edit', ['room' => $room->id]) }}" class="btn btn-warning btn-sm">Edit Room</a>
            </div>
        </div>
    </div>
</div>
