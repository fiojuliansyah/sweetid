                ...
                <div class="container">
                    <div class="company-detail">
                        <div class="detail-content">
                            <div class="flex-1">
                                <h4>{{ $room->title }}</h4>
                                <p>{{ $room->short_description }} <a href="javascript:void(0);"
                                        class="item-content item-link" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal5">baca selengkapnya ...</a></p>
                            </div>
                    ...
                    <div class="modal fade" tabindex="-1" id="exampleModal4" aria-labelledby="exampleModal4"
                        aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-body text-center small p-4">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="profile-tab-pane" aria-selected="false">Community
                                            Forum</button>
                                    </li>
                                </ul>
                            </div>
                                                    ...
                                                    @foreach ($courses as $course)
                                                        ...
                                                        <div class="modal fade" tabindex="-1"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    <div class="modal-body text-center small p-4">
                                                                        <iframe src="{{ $course->video }}" width="360"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <div class="d-flex justify-content-end">
                                                                    <a
                                                                        href="{{ route('product.discussion', $discussion->id) }}">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <div class="d-flex justify-content-end">
                                                                    <a href="#">
                                                                        <div class="badge badge-danger badge-pill">Beli Kursus
                                                                            Ini</div>
                                                                    </a>
                                                                </div>
                                                            </div>
            ...
            <div class="container">
                @if (Route::has('login'))
                    <div>
                        @auth
                            @if (!$room->is_joined)
                                <a href="{{ route('product.checkout', $room->id) }}"
                                    class="btn btn-primary text-start w-100 btn-rounded">
                                    <i class="	fas fa-money-bill me-2"></i> Enroll Now</a>
                                </a>
                            @endif
                        @else
