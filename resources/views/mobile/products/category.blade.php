...
@section('title')
    {{ $categories->name }} | SweetTroops - Baking Studio Apps
@endsection
...
<div class="page-content">
    <div class="container">
        <div class="search-area">
            ...
            <!-- TITLE -->
            <h4 class="title my-4">{{ $categories->name }} Class Room</h4>
            <!-- TITLE -->
                ...
                <ul>
                    ...
                    <li>
                        <div class="item-content">
                            ...
                            <div class="item-media media media-90"><img src="{{ Storage::url($room->cover) }}"
                                    alt="logo">
